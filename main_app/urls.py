...
urlpatterns = [
    ...
    path('ajax/send-new-message/', views.send_new_message, name='send-new-message'),
    ...
    path('ajax/load-conversation/<int:receiver>/<int:sender>/', views.load_conversation, name='load-conversation'),
