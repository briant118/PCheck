...
urlpatterns = [
    ...
    path('ajax/check-faculty-booking-status/', views.check_faculty_booking_status, name='check-faculty-booking-status'),
    path('ajax/check-my-faculty-booking-status/', views.check_my_faculty_booking_status, name='check-my-faculty-booking-status'),
    ...
    path('my-faculty-bookings/', views.my_faculty_bookings, name='my-faculty-bookings'),
