...
urlpatterns = [
    ...
    path('toggle-user-status/<int:pk>/', views.toggle_user_status, name='toggle-user-status'),
    path('suspend-user/<int:pk>/', views.suspend_user, name='suspend-user'),
    ...
    path('ajax/get-pc-status/', views.get_pc_status, name='get-pc-status'),
